...
> 💬 *Hi, this is my first project published on GitHub. Luckily I have my AI agent to help and guide me. I hope you enjoy this media player!*
...
- ✂️ **Intelligent Black Bar Auto-Cropping & Smart Fill**: Real-time video black bar analysis to crop cinematic letterboxes and subtitle bars.
...
| **`F` / `Double Click`** | Toggle Fullscreen | `Alt + Enter` |
| **`M`** | Mute / Unmute | - |
| **`=` / `-`** | Speed Up / Down (0.1x) | `F9` Reset 1.0x |
...
| **`C`** | Smart Aspect Ratio / Fill Mode | - |
